...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, orh.gnsg.gms.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, orh.gnsg.gms.repository.UserRepository.USERS_BY_EMAIL_CACHE);
            createCache(cm, orh.gnsg.gms.domain.User.class.getName());
            createCache(cm, orh.gnsg.gms.domain.Authority.class.getName());
