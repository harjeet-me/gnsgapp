...
/**
 * REST controller for managing {@link orh.gnsg.gms.domain.Revenue}.
 */
@RestController
@RequestMapping("/api")
public class RevenueResource {
    ...
    public ResponseEntity<Revenue> updateRevenue(@RequestBody Revenue revenue) throws URISyntaxException {
        ...
        return ResponseEntity.ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, revenue.getId().toString()))
            .body(result);
    }
