...
import orh.gnsg.gms.domain.enumeration.EVENTLOCATION;
import orh.gnsg.gms.domain.enumeration.LANGARMENU;
...
public class ProgramResourceIT {
     ...
     *
     * @see orh.gnsg.gms.repository.search.ProgramSearchRepositoryMockConfiguration
     */
    @Autowired
