...
import orh.gnsg.gms.repository.VendorRepository;
import orh.gnsg.gms.repository.search.VendorSearchRepository;
import orh.gnsg.gms.service.VendorService;
...
public class VendorResourceIT {
     ...
     *
     * @see orh.gnsg.gms.repository.search.VendorSearchRepositoryMockConfiguration
     */
    @Autowired
    ...
    public void updateVendor() throws Exception {
        ...
        // Validate the Vendor in Elasticsearch
        verify(mockVendorSearchRepository, times(2)).save(testVendor);
    }
